		...
		<div id="review_form_wrapper">
			<div id="review_form">
				...
				foreach ( $fields as $key => $field ) {
					...
					$field_html .= '</label><input class="w-100 form-control" id="' . esc_attr( $key ) . '" name="' . esc_attr( $key ) . '" type="' . esc_attr( $field['type'] ) . '" value="' . esc_attr( $field['value'] ) . '" size="30" ' . ( $field['required'] ? 'required' : '' ) . ' /></p>';
